...
namespace SH1106 {
    ...
    /**
     * Show text with selectable font size.
     */
    //% block="show text %text at x %x y %y size %size"
    //% x.min=0 x.max=127
    //% y.min=0 y.max=63
    //% size.min=1 size.max=3 size.defl=1
    //% weight=59
    export function showTextSize(
        text: string,
        x: number,
        y: number,
        size: number
    ...
    /**
     * Show a number on the OLED.
     */
    //% block="show number %number at x %x y %y size %size"
    //% x.min=0 x.max=127
    //% y.min=0 y.max=63
    //% size.min=1 size.max=3 size.defl=1
    //% weight=58
